  ...
  return (
    <div className="flex flex-wrap justify-center items-center gap-5  min-h-[10vh] text-2xl">
      {data.map((movie, index) => (
        <div
          className="card bg-base-100 w-60 min-h-70 shadow-sm p-2 hover:scale-"
          key={index + 1}
        >
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions  min-h-2 mt-3 hover:scale-95 ">
              <button className="btn btn-primary border text-[1rem] rounded-md p-2 bg-amber-400 hover:bg-amber-900 hover:text-white">
                Watch Now
              </button>
            </div>
          </div>
