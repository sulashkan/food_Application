...
function Welcome() {
  ...
  if (error)
    return (
      <p className="text-red-500 text-center h-177.5 mt-10">Error: {error}</p>
    );
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between text-center">
              ...
              <button
                ...
                className="mt-4  bg-[#e50914] hover:bg-[#ff1c1c] text-white font-medium py-2 rounded-full transition cursor-pointer"
              >
                Details
              </button>
            </div>
